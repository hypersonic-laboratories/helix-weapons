...
function NewHelixWeapons.ACM:Constructor(location, rotation)
	...
	self:SetAnimationFire("helix::A_ACM_Fire_RecoilRifleA")
	...
	self:SetAnimationCharacterEquip("helix::AM_Player_EquipRifleA")
...
NewHelixWeapons.Pit_Viper.image = 'https://i.imgur.com/UStYZIg.png'
...
function NewHelixWeapons.Fang:Constructor(location, rotation)
	...
	self:SetAnimationCharacterReload("helix::AM_Player_ReloadRifleA")
	-- self:SetAnimationReload("helix::A_Fang_Reload")
...
function NewHelixWeapons.PP:Constructor(location, rotation)
	...
	-- self:SetAnimationReload("helix::A_PP-Y_ReloadPistol")

	self:SetAnimationCharacterHolster("helix::AM_Player_HolsteringPistol")
	self:SetAnimationCharacterEquip("helix::AM_Player_EquipPistol")
...
function NewHelixWeapons.Vulcan:Constructor(location, rotation)
	...
	self:SetAnimationCharacterReload("helix::AM_Player_ReloadRifleA")
	-- self:SetAnimationReload("helix::A_Vulcan_Reload")
...
NewHelixWeapons.Convert.image = 'https://i.imgur.com/lTnRPCL.png'
...
function NewHelixWeapons.Convert:Constructor(location, rotation)
	...
	self:SetAnimationCharacterReload("helix::AM_Player_ReloadPistol")
	-- self:SetAnimationReload("helix::A_Convert_Reload")
...
NewHelixWeapons.Orion.image = 'https://i.imgur.com/2OZ8B61.png'
...
NewHelixWeapons.PM99.image = 'https://i.imgur.com/uN5vwyt.png'
...
function NewHelixWeapons.PM99:Constructor(location, rotation)
	...
	self:SetAnimationCharacterReload("helix::AM_Player_ReloadRifleA")
	-- self:SetAnimationReload("helix::A_PM-99_Reload")
...
NewHelixWeapons.M77.image = 'https://i.imgur.com/iCYAsXl.png'
...
function NewHelixWeapons.M77:Constructor(location, rotation)
	...
	self:SetAnimationCharacterReload("helix::AM_Player_ReloadPistol")
	-- self:SetAnimationReload("helix::A_M77_ReloadPistol")
...
function NewHelixWeapons.Bison:Constructor(location, rotation)
	...
	self:SetAnimationCharacterReload("helix::AM_Player_ReloadRifleA")
	-- self:SetAnimationReload("helix::A_Bison_Reload")
...
NewHelixWeapons.Mouflan.image = 'https://i.imgur.com/xh6heBN.png'
...
function NewHelixWeapons.Mouflan:Constructor(location, rotation)
	...
	self:SetAnimationCharacterReload("helix::AM_Player_ReloadRifleA")
	-- self:SetAnimationReload("helix::A_Mouflan_Reload")
...
function NewHelixWeapons.Mirage:Constructor(location, rotation)
	...
	self:SetAnimationCharacterFire("helix::AM_Player_Fire_RecoilPistol")
	self:SetAnimationFire("helix::A_Mirage_Fire_RecoilPistol")
...
function NewHelixWeapons.Fierro:Constructor(location, rotation)
	...
	self:SetAnimationCharacterFire("helix::AM_Player_Fire_Recoil_Fierro")
	self:SetAnimationFire("helix::A_Fierro_Fire_Recoil_Fierro")
...
NewHelixWeapons.KTK.image = 'https://i.imgur.com/KsUlxNJ.png'
...
NewHelixWeapons.Remi.image = 'https://i.imgur.com/w8fYpyQ.png'
...
NewHelixWeapons.DB12.image = 'https://i.imgur.com/E50jdRf.png'
...
NewHelixWeapons.LWS32.image = 'https://i.imgur.com/bFEcbJd.png'
...
NewHelixWeapons.KFS.image = 'https://i.imgur.com/mwpfqUB.png'
...
NewHelixWeapons.Sabra.image = 'https://i.imgur.com/bNElCwB.png'
...
NewHelixWeapons.CS446.image = 'https://i.imgur.com/2s6PleX.png'
...
function NewHelixWeapons.CS446:Constructor(location, rotation)
	...
	self:SetAnimationCharacterFire("helix::AM_Player_Fire_RecoilSniperA")
	self:SetAnimationFire("helix::A_CS-446_Fire_RecoilSniperA")

	self:SetAnimationCharacterReload("helix::AM_Player_ReloadSniperA")
...
NewHelixWeapons.Ronin777.image = 'https://i.imgur.com/REq6OaI.png'
...
function NewHelixWeapons.Ronin777:Constructor(location, rotation)
	...
	self:SetAnimationCharacterFire("helix::AM_Player_Fire_RecoilSniperA")
	-- self:SetAnimationFire("helix::A_Ronin-777_Fire_RecoilSniperA")
...
function NewHelixWeapons.DMC68:Constructor(location, rotation)
	...
	self:SetAnimationCharacterFire("helix::AM_Player_Fire_RecoilSniperB")
	self:SetAnimationFire("helix::A_DMC-68_Fire_RecoilSniperB")

	self:SetAnimationCharacterReload("helix::AM_Player_ReloadSniperB")
